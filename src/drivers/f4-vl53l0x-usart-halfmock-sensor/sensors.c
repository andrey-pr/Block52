...
static void Prepare_I2C(void)
{
	...
	SENSORS_VL_GPIO_RCC_Enable();
	GPIO_InitStruct.Pin = SENSORS_VL_GPIO_SCL;
	GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
	GPIO_InitStruct.Pull = GPIO_PULLUP;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
	GPIO_InitStruct.Alternate = SENSORS_VL_GPIO_SCL_AF;
	HAL_GPIO_Init(SENSORS_VL_GPIO_SCL_PORT, &GPIO_InitStruct);
	GPIO_InitStruct.Pin = SENSORS_VL_GPIO_SDA;
	GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
	GPIO_InitStruct.Pull = GPIO_PULLUP;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
	GPIO_InitStruct.Alternate = SENSORS_VL_GPIO_SDA_AF;
	HAL_GPIO_Init(SENSORS_VL_GPIO_SDA_PORT, &GPIO_InitStruct);

	SENSORS_VL_I2C_RCC();
	hi2c1->Instance = SENSORS_VL_I2C;
